...
public protocol CycleViewProtocol {
...
public class CycleView: UIView {
    ...
    public var pageControlAlignment: PageControlAlignment = .center {
    ...
    /// delegate
    public var delegate: CycleViewProtocol?
    /// 点击了item
    ...
    //=============================================
    fileprivate var flowLayout: CycleLayout!
    ...
    private func addPageControl() {
        pageControl = PageControl(frame: CGRect(x: 0, y: bounds.size.height - pageControlHeight, width: bounds.size.width, height: pageControlHeight))
